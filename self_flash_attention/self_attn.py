...
save_tensor_bin(Q, "/workspace/cuda_code/course9/Q.bin")
print(Q)
print(Q.shape)
save_tensor_bin(K, "/workspace/cuda_code/course9/K.bin")
save_tensor_bin(V, "/workspace/cuda_code/course9/V.bin")
save_tensor_bin(O, "/workspace/cuda_code/course9/O.bin")
