...
void self_attention_with_io(int m, int n) {
  ...
  // Read inputs
  read_bin("/workspace/cuda_code/course9/Q.bin", h_Q, num_elements);
  read_bin("/workspace/cuda_code/course9/K.bin", h_K, num_elements);
  read_bin("/workspace/cuda_code/course9/V.bin", h_V, num_elements);
  ...
  write_bin("/workspace/cuda_code/course9/O_cuda.bin", h_O,
            num_elements);
