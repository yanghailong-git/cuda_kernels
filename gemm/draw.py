...
# data = np.genfromtxt('/workspace/cuda_code/course5_1/sgemm_benchmark_v1.csv', delimiter=',', skip_header=1)
data = np.genfromtxt('/workspace/cuda_code/course5_1/sgemm_benchmark_v8.csv', delimiter=',', skip_header=1)
# data = np.genfromtxt('/workspace/cuda_code/course5_1/sgemm_benchmark_v7.csv', delimiter=',', skip_header=1)
...
# 设置图表标题和坐标轴标签
plt.title("CUBLAS vs MySGEMM_v8 GFLOPS", fontsize=14)
...
# plt.savefig("cublas_vs_mysgemm_v1.png", dpi=300)
plt.savefig("cublas_vs_mysgemm_v8.png", dpi=300)
